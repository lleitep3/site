    ...
    <div class="container">
      <div class="row fix-space-top">
        ...
        <div class="col-xs-12 col-sm-8 center">
          ...
          <div class="md-card landscape">
            <div class="picture">
              <img src="/img/lleite2.jpg" class="img-responsive">
            </div>
            <p>
          ...
          <div class="md-card">
            <p class="row social">
              <span class="col-xs-4 text-center">
                <a href="http://br.linkedin.com/in/lleitep3"
                   alt="LinkedIn lleitep3" alt="LinkedIn lleitep3">
                  <i class="icon ion-social-linkedin"></i>
                </a>
              </span>

              <span class="col-xs-4 text-center">
                <a href="https://github.com/lleitep3"
                   alt="GitHub @lleitep3" title="GitHub @lleitep3">
                  <i class="icon ion-social-github"></i>
                </a>
              </span>

              <span class="col-xs-4 text-center">
                <a href="https://twitter.com/lleitep3"
                   alt="Twitter @lleitep3" title="Twitter @lleitep3">
